...
var jsPicker = function (file) {
  if (file.path.match(/.*\.js$/g) && file.path.indexOf('scripts/lib') == -1){
    return true;
  }
  return false;
}
...
gulp.task('jshint', function () {
  return gulp.src(['app/**/*.js','!app/**/*_test.js','!app/bower_components/**'])
...
gulp.task('html', function () {
  return gulp.src('app/**/*.html')
    ...
    // Concatenate And Minify JavaScript (unless already minified)
    .pipe($.if(jsPicker, $.uglify({preserveComments: 'some'})))
